...
def run(data_dir, output_dir, resolution_factor, grid_resolution, interp_method):
    ...
    # ================================================================
    print(f"\nReducing DEM resolution by factor {resolution_factor}...")
    ...
    print(f"  Rows after reduction: {len(df_dem_reduced)}")
    ...
    # ================================================================
    print(f"\nBuilding regular grid (resolution={grid_resolution}) and interpolating ({interp_method})...")
    ...
    for var in variables:
        if df_combined[var].nunique() > 1:
            ...
            print(f"  Warning: {var} has a single unique value, skipping plot.")
    ...
    print(f"  Interpolated CSV saved: {interp_csv}")

    # ================================================================
    # 5. NORMALIZE (Min-Max 0-1)
    # ================================================================
    print("\nNormalizing variables (Min-Max 0-1)...")
    ...
    print(f"  Normalized CSV saved: {norm_csv}")
    ...
    print("\nprocess-data finished successfully.")
